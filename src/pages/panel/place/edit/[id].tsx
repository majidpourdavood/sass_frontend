...
function UpdatePlace(props) {
    ...
    const center = {
        lat:  props ? props.getPlace.data.lat : 35.79957624375943,
        lng:  props ? props.getPlace.data.lng : 51.41704559326172,
    }
    ...
    const submitForm = async (e) => {
        ...
        let PlaceId = props.getPlace ? props.getPlace.data.id : "";
        let message = "";
        const url = process.env.URL_WEBSITE_SERVER + constants.URL_UPDATE_Place + PlaceId
    ...
    return (
        <>
            <Head>
                <title>ManagePetro | Edit place</title>
                <meta name="description" content="ManagePetro | Edit place"/>
            </Head>
            <div className="container-fluid">
                <div className="card shadow mb-4">
                    <div className="card-header d-flex align-items-center py-3">
                        <h6 className="m-0 font-weight-bold text-primary col-6">Edit place</h6>
...
export async function getServerSideProps({req, res, params}) {
    ...
    try {
        ...
        const urlGetPlace = process.env.URL_WEBSITE_SERVER + constants.URL_GET_Place + idPlace;

        getPlace = await axios(urlGetPlace, {
            method: "GET",
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
