...
function UpdateDelivery(props) {
    ...
    const [initialValues, setInitialValues] = useState({
        name: props ? props.getDelivery.data.name : "",
        capacity: props ? props.getDelivery.data.capacity : 12,
    ...
    const submitForm = async (e) => {
        ...
        let deliveryId = props.getDelivery ? props.getDelivery.data.id : "";
        let message = "";
        const url = process.env.URL_WEBSITE_SERVER + constants.URL_UPDATE_Delivery + deliveryId
    ...
    return (
        <>
            <Head>
                <title>ManagePetro | Edit Delivery</title>
                <meta name="description" content="ManagePetro | Edit Delivery"/>
            </Head>
            <div className="container-fluid">
                <div className="card shadow mb-4">
                    <div className="card-header d-flex align-items-center py-3">
                        <h6 className="m-0 font-weight-bold text-primary col-6">Edit Delivery</h6>
...
export async function getServerSideProps({req, res, params}) {
    ...
    try {
        ...
        const urlGetDelivery = process.env.URL_WEBSITE_SERVER + constants.URL_GET_Delivery + idDelivery;

        getDelivery = await axios(urlGetDelivery, {
            method: "GET",
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
